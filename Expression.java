...
//
// AUTHOR
// Heather Fryling hfryling@asu.edu Done according to a template provided by Kevin Burger.
//********************************************************************************************************
package p04;
...
public class Expression {
    ...
    public Expression(String pExprStr) {
        setTokenQueue(mTokenQueue = new Queue<Token>());
    ...
    private void topEval(Stack<Operator> pOperatorStack, Stack<Operand> pOperandStack) {
        ...
        if (operator instanceof UnaryOperator) {
            ...
            pOperandStack.push(unaryOperator.evaluate(right));
        } else {
            Operand left = pOperandStack.pop();
            BinaryOperator binOperator = (BinaryOperator) operator;
            binOperator.evaluate(left, right);
            pOperandStack.push(binOperator.evaluate(left, right));
        }
