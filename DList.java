...
public class DList<E> {
    ...
    protected static class Node<E> {
         ...
         * equal is defined as:
         *
         * 1. If pNode is null, returns false. 2. If mNode == pNode is true,
         * returns true. 3. If the instance variables of this Node are equal to
         * the instance variables of pNode returns true. 4. Otherwise, returns
         * false.
         */
        @Override
